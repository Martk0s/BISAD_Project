...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Apr 22, 2020 at 09:35 AM
...
(1, NULL, '69/69 asdf', 'pending', '0.00', 3);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'admin', '-', '-', '-', 'staff'),
(3, 'asdf', '912ec803b2ce49e4a541068d495ab570', 'asdf', 'asdf', 'asdf', '0696969969', '69/69 asdf', 'customer'),
(4, 'asdfqwer', '912ec803b2ce49e4a541068d495ab570', 'qwer', 'qwer', 'qwer', '0909999969', '1/1 qwer qwer qwer qwerqwer', 'customer');
...
--
ALTER TABLE `user_account`
  MODIFY `user_account_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `cus_order`
  ADD CONSTRAINT `cus_order_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `user_account` (`user_account_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
